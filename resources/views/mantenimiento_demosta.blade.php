    ...
    <header class="hero">
        <nav class="nav container container-fluid">
            ...
            <ul class="nav__link nav__link--menu d-flex">
                ...
                <li class="nav__items">
                    <a href="/HTML/login.html" class="nav__links">Login</a>
                </li>
                <li class="nav__items">
        ...
        <section class="hero__container container">
            <h1 class="hero__title">Realiza un mantenimiento confiable y garantizado .</h1>
            <p class="hero__paragraph">Nuestro servicio especializado en mantenimiento biomédico ofrece una solución integral que va más allá de simplemente reparar equipos. de gran </p>
            ...
            <div class="footer-content">
                ...
                <div class="footer-columns">
                    ...
                    <div class="footer-column2">
                        ...
                        <h4>Recibe Noticias en tu Email</h4>
                        <form action="" class="news-form">
                            <input type="text" class="news-input" placeholder="Ingresa tu correo electrónico">
