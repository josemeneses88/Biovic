                                    ...
                                    <div class="message-notif-scroll scrollbar-outer">
                                        <div class="notif-center">
                                            <a href="#">
                                                <div class="notif-img">
                                                    <img
                                                        src="{{ asset('atlantis/assets/img/jm_denis.jpg" alt="Img Profile') }}">
                                                </div>
                                            ...
                                            <a href="#">
                                                <div class="notif-img">
                                                    <img
                                                        src="{{ asset('atlantis/assets/img/chadengle.jpg" alt="Img Profile') }}">
                                                </div>
                                                <div class="notif-content">
                                            ...
                                            <a href="#">
                                                <div class="notif-img">
                                                    <img
                                                        src="{{ asset('atlantis/assets/img/mlane.jpg" alt="Img Profile') }}">
                                                </div>
                                                <div class="notif-content">
                                            ...
                                            <a href="#">
                                                <div class="notif-img">
                                                    <img
                                                        src="{{ asset('atlantis/assets/img/talha.jpg" alt="Img Profile') }}">
                                                </div>
                                                <div class="notif-content">
                                    ...
                                    <div class="notif-scroll scrollbar-outer">
                                        <div class="notif-center">
                                            ...
                                            <a href="#">
                                                <div class="notif-img">
                                                    <img
                                                        src="{{ asset('atlantis/assets/img/profile2.jpg" alt="Img ') }}">
                                                </div>
                                                <div class="notif-content">
                                                    <span class="block">
            ...
            <div class="sidebar-wrapper scrollbar scrollbar-inner">
                <div class="sidebar-content">
                    ...
                    <ul class="nav nav-primary">
                        ...
                        <li
                            class="nav-item {{ request()->routeIs(['usuarios.create', 'usuarios.store']) ? 'active' : '' }} ">
                            <a data-toggle="collapse" href="#usuarios">
                                <i class="fas fa-layer-group"></i>
                                <p>Usuarios</p>
                                <span class="caret"></span>
                            </a>
                            {{-- peticion para todas las rutas con usuarios --}}
